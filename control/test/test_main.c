...
void test_bms_rx(void);     /* BMS/DVCC control-in (deliverable #10, CAN_INTEGRATION.md §1) */
void test_bms_ceilings(void); /* deliverable #10: CVL enforcement + pre-disconnect ramp (PROFILE_SPEC_LFP.md §6/§8.1) */
